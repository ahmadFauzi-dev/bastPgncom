Ext.define('siangsa.user.form_editdraft' ,{
		...
		initComponent: function() {
			...
			var gridattdokumen = Ext.create('siangsa.user.gridattdokumenedit');
			var gridworkflow = Ext.create('siangsa.user.gridworkflowedit');
			var gridbiayatambahan = Ext.create('siangsa.user.grideditbiayatambahan');
								...
								if(this.up('form').getForm().isValid()){
				            		this.up('form').getForm().submit({
										...
										success	:function(form, action)
										{
											...
											Ext.getCmp('idgrid_permohonanbast').getStore().load();
										},
