Ext.define('siangsa.user.gridbiayatambahan' ,{
				...
				dockedItems	: [
					{
						...
						items	: [
						{
							...
							{			
									...
									{
										var formgridtambahan = Ext.create('siangsa.user.formgridtambahan');
										Init.winss_formgridtambahan = Ext.widget('window', {
											title		: "Form Tambahan Biaya",
											closeAction	: 'close',
											width: 500,
											height	: 300,
											...
											bodyPadding	: 5,
											layout		: 'fit',
											items		: formgridtambahan,
											/* listeners: {
												close: function() {
													Ext.getCmp('formgridtambahan'+pageId).destroy();
												}
											}, */
										});
									}
									//Ext.getCmp('formgridtambahan'+pageId).getForm().reset();
									Init.winss_formgridtambahan.show();		
							}
						},
						{
								text	: 'Delete',
