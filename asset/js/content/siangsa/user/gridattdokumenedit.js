Ext.define('siangsa.user.gridattdokumenedit' ,{
			...
			dockedItems	: [
				{
					...
					items	: [
					{
						...
						handler	: function()
						{
								...
								{
									var formattdokumenedit = Ext.create('siangsa.user.formduploadedit');
								...
								Ext.getCmp('formduploadedit'+pageId).getForm().reset();
