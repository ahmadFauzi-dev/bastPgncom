Ext.define('siangsa.user.formgridtambahan' ,{	
				...
				items		: [
						...
						listeners: {
							change: function(combo, record, index) {								
									if (record){
										...
										Ext.getCmp("nama_jenis"+pageId).setValue(name);
										Ext.getCmp("mvalue"+pageId).setValue(mvalue);
									}
								}
						}
					},
					...
					buttons		: [
					{
							...
							handler: function(){
											...
											var store = Ext.getCmp('gridbiayatambahan'+'add').getStore();
											var r = {
														rowid : '',
											...
											Init.winss_formgridtambahan.close();
											Init.winss_formgridtambahan = '';
