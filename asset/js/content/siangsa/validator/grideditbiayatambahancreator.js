Ext.define('siangsa.validator.grideditbiayatambahancreator' ,{
	...
	initComponent	: function()
	{
		...
		Ext.apply(this, {
				...
				layout : 'fit',
				height : 200,
				id			: 'grideditbiayatambahancreator'+pageId,
				dockedItems	: [
					{
						xtype: 'toolbar',
						items	: [
						{
							...
							{									
									...
									{
										var formgridedittambahancreator = Ext.create('siangsa.validator.formeditgridtambahancreator');
										Init.winss_formeditgridtambahancreator = Ext.widget('window', {
											...
											bodyPadding	: 5,
											layout		: 'fit',
											items		: formgridedittambahancreator,
											listeners: {
												close: function() {
													Ext.getCmp('formeditgridtambahancreator'+pageId).destroy();
												}
											},
										});
									}
									//Ext.getCmp('formeditgridtambahancreator'+pageId).getForm().reset();
									Init.winss_formeditgridtambahancreator.show();					
							}
						},
						{
								text	: 'Delete',
