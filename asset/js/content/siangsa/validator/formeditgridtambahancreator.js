Ext.define('siangsa.validator.formeditgridtambahancreator' ,{	
	...
	initComponent: function() {	
		...
		Ext.apply(this, {
				...
				header:false,
				frame : true,
				id:'formeditgridtambahancreator'+pageId,
    			fileUpload : true,
				...
				items		: [
					...
					buttons		: [
					{
							...
							handler: function(){
											...
											var store = Ext.getCmp('grideditbiayatambahancreator'+pageId).getStore();
											var r = {
														rowid : '',
											...
											Init.winss_formeditgridtambahancreator.close();
