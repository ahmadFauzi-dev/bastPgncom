function apps(name, iconCls) {
    ...
    var formanomaliamr = Ext.create('dashboard.form.searchvalidasiparetoanomalienergi');
				...
				items	: [{
					...
					items	: [			
					{
						...
						items	: [{
							...
							id		: 'tableauviz',
							flex	: 1,
							vizUrl	: "http://192.168.104.167:8000/trusted/"+tiketnumber+"/#/views/DashboardPencapaianEnergy/DashboardPemakaianVolumeM3?start_date="+tanggal_awal+"&end_date="+tanggal_akhir+"&:refresh=yes&:toolbar=no&:tabs=no&group_id="+group_id+"&username="+username+""
						}]						
					}]
				}]
            }]
