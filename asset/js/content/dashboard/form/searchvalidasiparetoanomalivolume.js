Ext.define('dashboard.form.searchvalidasiparetoanomalivolume' ,{
							...
							handler	: function()
							{
								...
								var panelchart = Ext.create('Ext.panel.Panel', {
									...
									items	: [{
										...
										//id		: 'tableauviz',
										flex	: 1,
										vizUrl	: "http://192.168.104.167:8000/trusted/"+tiketnumber+"/#/views/DashboardVolmum3_0/mscf?Area="+oksparams.area+"&start_date="+oksparams.startdate+"&end_date="+oksparams.endd+"&idreff="+oksparams.id_pel+"&nmpel="+oksparams.namapel+"&sbu="+oksparams.sbu+"&:refresh=yes&:toolbar=no&:tabs=no"
									}]
								});
								//console.log("http://192.168.104.167:8000/#/views/DashboardVolmum3/DashboardPemakaianVolumeM3?Area="+oksparams.area+"&start_date="+oksparams.startdate+"&end_date="+oksparams.endd+"&idreff="+oksparams.id_pel+"&nmpel="+oksparams.namapel+"");
								//panelprovisionalvalidasi
