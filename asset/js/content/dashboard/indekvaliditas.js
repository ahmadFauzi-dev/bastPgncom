function apps(name, iconCls) {
    ...
    var formanomaliamr = Ext.create('dashboard.form.searchindeks');
	...
	console.log("http://192.168.104.167:8000/trusted/"+tiketnumber+"/#/views/DataIndeks/Dashboard?:refresh=yes&:toolbar=yes&:tabs=no&group_id="+group_id+"&username="+username+"");
				...
				items	: [{
					...
					items	: [			
					{
						...
						items	: [{
							...
							id		: 'tableauviz',
							flex	: 1,
							vizUrl	: "http://192.168.104.167:8000/trusted/"+tiketnumber+"/#/views/DataIndeks/Dashboard?:refresh=yes&:toolbar=yes&:tabs=no&group_id="+group_id+"&username="+username+""
						}]
						//items: gridkelData						
					}]
				}]
