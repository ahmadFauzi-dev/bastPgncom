function apps(name, iconCls) {
    ...
    var formanomaliamr = Ext.create('dashboard.form.searchvalidasiparetoanomalivolume');
				...
				items	: [{
					...
					items	: [			
					{
						...
						items	: [{
							...
							id		: 'tableauviz',
							flex	: 1,
							vizUrl	: "http://192.168.104.167:8000/trusted/"+tiketnumber+"/#/views/DashboardVolmum3_0/mscf?start_date="+tanggal_awal+"&end_date="+tanggal_akhir+"&:refresh=yes&:toolbar=no&group_id="+group_id+"&username="+username+""
						}]						
					}]
				}]
            }]
	...
	var me = this;
	console.log("http://192.168.104.167:8000/trusted/"+tiketnumber+"/#/views/DashboardVolmum3_0/mscf?start_date="+tanggal_awal+"&end_date="+tanggal_akhir+"&:refresh=yes&:toolbar=no&group_id="+group_id+"&username="+username+"");
	/*
