Ext.define('master.view.gridpointtype' ,{
	extend: 'Ext.grid.Panel',
	initComponent	: function()
	{
	var msclass = Ext.create('master.global.geteventmenu'); 
	var model = msclass.getmodel('pointtypedesc');
	var columns = msclass.getcolumn('pointtypedesc');
	var filter = [];
	var store =  msclass.getstore(model,'pointtypedesc',filter);
	store.load();
