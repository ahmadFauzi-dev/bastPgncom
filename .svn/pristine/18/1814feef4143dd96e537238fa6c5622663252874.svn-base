Ext.define('siangsa.user.gridtujuaninternalskdetail' ,{
		...
		var coldisplay = columns;
											...
											editor		: {
												...
												listeners: {
													select: function(cmb, record, index){
															...
															Ext.getCmp('str_satuankerjaskdetail'+pageId).setValue(name);
															Ext.getCmp('reffkepalaskdetail'+pageId).setValue(reffkepala);
															Ext.getCmp('reffsekertarisskdetail'+pageId).setValue(reffsekertaris);
															Ext.getCmp('nama_kepalaskdetail'+pageId).setValue(nama_kepala);
															Ext.getCmp('nama_sekertarisskdetail'+pageId).setValue(nama_sekertaris);
													}
												}	
											}
					};
					coldisplay[3] = {
						...
						editor		: {
							...
							id : 'str_satuankerjaskdetail'+pageId,
							readOnly : true
						}
					};
					...
					coldisplay[13] = {
						...
						editor		: {
							...
							id : 'reffsekertarisskdetail'+pageId,
							readOnly : true
						}
					};
					coldisplay[14] = {
					...
					coldisplay[15] = {
						...
						editor		: {
							...
							id : 'nama_sekertarisskdetail'+pageId,
							readOnly : true
						}
					};
