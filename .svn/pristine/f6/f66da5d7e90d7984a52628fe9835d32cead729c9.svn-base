Ext.define('siangsa.validator.formpermohonandetailcreator' ,{
		...
		initComponent: function() {	
			...
			var filter = [];
			var gridattdokumen = Ext.create('siangsa.validator.gridattdokumenskdetailcreator');
		...
		Ext.apply(this, {
				...
				id			: 'formpermohonandetailcreator'+pageId,
				flex : 1,
