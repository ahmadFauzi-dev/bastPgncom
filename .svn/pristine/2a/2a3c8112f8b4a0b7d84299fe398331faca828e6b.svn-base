Ext.define('siangsa.validator.formduploadeditcreator' ,{	
	...
	initComponent: function() {	
		...
		Ext.apply(this, {
				...
				header:false,
				frame : true,
				id:'formduploadeditcreator'+pageId,
    			fileUpload : true,
				...
				items		: [
						...
						queryMode: 'local',
							...
							change: function(combo, record, index) {								
								if (record){
									...
									Ext.getCmp("nama_jeniseditcreator"+pageId).setValue(nama);
								}
							}
						}
					},
					{
						...
						id: "nama_jeniseditcreator"+pageId,
						name: "nama_jenis",
						hidden:true
					},
					{
										...
										if(this.up('form').getForm().isValid()){
											this.up('form').getForm().submit({
												...
												success	:function(response,opt)
												{
													...
													var store = Ext.getCmp('gridattdokumeneditcreator'+pageId).getStore();
													var r = {
																	rowid : '',
																	nomor : ar.data.nomor,
													...
													Ext.getCmp('formduploadeditcreator'+pageId).getForm().destroy();
